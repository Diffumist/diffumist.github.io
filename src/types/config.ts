...
interface FeaturesConfig {
  ...
  editPost?:
    ...
    | { enabled: false };
  /**
   * Search provider. "minisearch" builds a client-side full-text index.
   * Set to false to disable search entirely.
   */
  search?: "minisearch" | false;
}
...
interface AstroPaperConfig {
  ...
  /** Services listed on the links page */
  services?: LinkItem[];
  /** Projects listed on the links page */
  projects?: LinkItem[];
  /** Private services listed on the links page */
  privateServices?: LinkItem[];
}
